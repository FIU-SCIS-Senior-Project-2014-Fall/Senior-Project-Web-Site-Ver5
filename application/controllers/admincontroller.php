  ...
  public function register_new_user( )
    ...
    if ($this->form_validation->run( ) !== false)
    {
	  ...
	  $message = $row[ 'intro' ];
		...
		$message = $message . '<br><a href="http://spws-dev.cis.fiu.edu/senior-project-website-v4/admin/email_activation/' . $this->reversible_encryption( $user_id ) . '"> http://spws-dev.cis.fiu.edu/senior-project-website-v4/admin/email_activation/'. $this->reversible_encryption( $user_id ) . '</a>';    	
	  ...
	  if( $this->form_validation->run( ) != false )
	  {
        ...
        <p>We have created an account for you to access it.</p>
          ...
          <p>Once you login, update your profile and refer to the User Guide on the "About" page for help.</p>
            <p><a href="http://spws-dev.cis.fiu.edu/senior-project-website-v4">Senior Project Website</a></p>
            </body>
            </html>';
